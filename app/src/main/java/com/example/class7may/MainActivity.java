...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // insert a Third task for assignment 6
        Task task3 = new Task(1, "Do Assignment 6", "", "0", "0");
        long insertId3 = db.insertTask(task3);
        if (insertId3 > 0) {
            sb.append("Row inserted! Insert Id: " + insertId3 + "\n");
        }

        // insert a Fourth task for assignment 6
        Task task4 = new Task(1, "Do Assignment 6 online", "", "0", "0");
        long insertId4 = db.insertTask(task4);
        if (insertId4 > 0) {
            sb.append("Row inserted! Insert Id: " + insertId4 + "\n");
        }

        // insert a Fifth task for assignment 6
        Task task5 = new Task(1, "Practice more", "", "0", "0");
